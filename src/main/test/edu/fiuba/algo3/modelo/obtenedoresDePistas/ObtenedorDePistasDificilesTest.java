...
public class ObtenedorDePistasDificilesTest {

    ObtenedorDePistasDificiles obtenedor = new ObtenedorDePistasDificiles();
    ...
    public void test01ObtengoUnaPista() {
        ...
        when(ciudad.pistaDificilAeropuerto()).thenReturn("Los landmarks son Mount Fiji");

        assertEquals(obtenedor.pedirPista(aeropuerto, mision), "Los landmarks son Mount Fiji, pelo rojo");
    }
}
